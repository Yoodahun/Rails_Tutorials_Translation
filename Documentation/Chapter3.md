...
Test Suite 는 예상대로 성공(GREEN) 합니다. (성공 시에 색을 표시하기 위해서는 [3.6.1](#361-minitest-reporters) 에서 설명하는 minitest reporters를 추가할 필요가 있습니다만, 보기 편하기 하기 위함이기 때문에 필수 사항은 아닙니다.) 테스트를 실행하기에는 어느정도 시간이 걸립니다. 여기에는 2가지 이유가 있습니다. 
